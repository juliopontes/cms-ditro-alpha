 ...
 */
 function JFormValidator()
 {
	...
	this.attachToForm(jQuery('form.form-validate'));
 }

JFormValidator.prototype.setHandler = function(name, fn, en)
{
	en = (en == '') ? true : en;
	this.handlers[name] = { enabled: en, exec: fn };
}

JFormValidator.prototype.attachToForm = function(form)
{
	if (typeof form  === "Object") {
		// Iterate through the form object and attach the validate method to all input fields.
		elements = {};
		jQuery.extend(elements, form.find('input'), form.find('textarea'), form.find('select'), form.find('button'));
		jQuery.each(elements,function(i,arr){
